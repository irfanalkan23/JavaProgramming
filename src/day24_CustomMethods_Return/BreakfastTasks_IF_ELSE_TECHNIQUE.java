...
public class BreakfastTasks_IF_ELSE_TECHNIQUE {
...
//domain("ia@gmail.com");
    ...
    public static void nameOfMonth(int number){  // 95
        ...
        }else{                  // USE THIS TYPE IF ELSE --> if you put else inside the method
                                // compiler goes through all the else statements above!
            name = "Invalid";
        }
