...
public class ListOfMapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        scrumTeams.addAll(Arrays.asList(scrumTeam2, scrumTeam4, scrumTeam5));
...
//        Print the names of all employees
        ...
        System.out.println("--------------1.2 Print the names of all scrum masters---------------");
        System.out.println("--------------1.3 Print the names of all Developers---------------");
...
//            }
            for (Map.Entry<String, String> pair : eachScrumTeam.entrySet()) {
                if(pair.getValue().equals("SM")){
                    System.out.println("SM: " + pair.getKey());
                }
            }

            for (Map.Entry<String, String> pair : eachScrumTeam.entrySet()) {
                if(pair.getValue().equals("Developer")){
                    System.out.println("Developer: " + pair.getKey());
                }
            }
        }
