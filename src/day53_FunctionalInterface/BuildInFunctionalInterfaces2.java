...
public class BuildInFunctionalInterfaces2 {
    ...
    public static void main(String[] args) {
        ...
        //create a function that can check if two strings are anagram (all characters incluede)
        ...
        System.out.println(anagram.test("abc", "cba"));
        ...
        //1.create a function that takes two integers and returns max number
...
//        System.out.println(nums);
        ...
        BiFunction<List<String>, List<Integer>, Map<String, Integer>>  merge2 = (j, k) ->{
            Map<String, Integer> map = new HashMap<>(); //HashMap because faster
